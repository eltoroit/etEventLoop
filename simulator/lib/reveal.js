...
!(function (e, t) {
	...
	var Q,
		...
		te = t(function (e) {
			...
			(e.exports = function (e, t, a, o) {
				var s = !!o && !!o.unsafe,
					l = !!o && !!o.enumerable,
					c = !!o && !!o.noTargetGet;
				'function' == typeof a && ('string' != typeof t || b(a, 'name') || P(a, 'name', t), (n(a).source = r.join('string' == typeof t ? t : ''))),
					e !== i ? (s ? !c && e[t] && (l = !0) : delete e[t], l ? (e[t] = a) : P(e, t, a)) : l ? (e[t] = a) : N(t, a);
		...
		qe = function (e, t) {
			var n;
			return (
				Ie(e) && ('function' != typeof (n = e.constructor) || (n !== Array && !Ie(n.prototype)) ? p(n) && null === (n = n[ze]) && (n = void 0) : (n = void 0)),
	...
	var Ct =
		...
		sn = function (e, t, n) {
			...
			return (
				x(n),
				b(Gt, i)
					? (n.enumerable ? (b(e, Bt) && e[Bt][i] && (e[Bt][i] = !1), (n = Ct(n, { enumerable: c(0, !1) }))) : (b(e, Bt) || $t(e, Bt, c(1, {})), (e[Bt][i] = !0)), rn(e, i, n))
					: $t(e, i, n)
			);
		},
		ln = function (e, t) {
	...
	if (
		...
		Me({ target: 'Object', stat: !0, forced: !De }, { getOwnPropertyNames: dn, getOwnPropertySymbols: hn }),
		Me(
			{
				target: 'Object',
				stat: !0,
		...
		{ target: 'Array', stat: !0, forced: Bn },
		{
			from: function (e) {
				var t,
					...
					h = On(s),
					f = 0;
				if ((d && (u = tt(u, c > 2 ? arguments[2] : void 0, 2)), null == h || (l == Array && xn(h)))) for (n = new l((t = ce(s.length))); t > f; f++) (o = d ? u(s[f], f) : s[f]), Te(n, f, o);
				else for (a = (r = h.call(s)).next, n = new l(); !(i = a.call(r)).done; f++) (o = d ? En(r, u, [i.value, f], !0) : i.value), Te(n, f, o);
				return (n.length = f), n;
			}
		}
	);
		...
		{ target: 'Array', proto: !0, forced: !Wn || !Kn },
		{
			splice: function (e, t) {
				var n,
					...
					u = he(e, c),
					d = arguments.length;
				if ((0 === d ? (n = i = 0) : 1 === d ? ((n = 0), (i = c - u)) : ((n = d - 2), (i = Xn($n(se(t), 0), c - u))), c + n - i > 9007199254740991))
	...
	(Ni && Mi) ||
		...
		'process' == d(Ii)
			...
			: Oi && !Ci
			? ((Ei = (Si = new Oi()).port2), (Si.port1.onmessage = Bi), (wi = tt(Ei.postMessage, Ei, 1)))
			: !i.addEventListener || 'function' != typeof postMessage || i.importScripts || r(Fi) || 'file:' === Pi.protocol
			? (wi =
	...
	var rr,
						...
						try {
							d
								? (a || (2 === t.rejection && Dr(e, t), (t.rejection = 1)),
								  !0 === d ? (s = r) : (v && v.enter(), (s = d(r)), v && (v.exit(), (c = !0))),
								  s === u.promise ? f(wr('Promise-chain cycle')) : (l = Nr(s)) ? l.call(s, h, f) : h(s))
								: f(r);
						} catch (e) {
							v && !c && v.exit(), f(e);
						}
		...
		Ir = function (e, t, n) {
			var r, a;
			Lr ? (((r = Sr.createEvent('Event')).promise = t), (r.reason = n), r.initEvent(e, !1, !0), i.dispatchEvent(r)) : (r = { promise: t, reason: n }),
				(a = i['on' + e])
					? a(r)
	...
	var Jr,
		...
		oa = Fe('iterator'),
		sa = !1;
	[].keys && ('next' in (Zr = [].keys()) ? (Qr = aa(aa(Zr))) !== Object.prototype && (Jr = Qr) : (sa = !0)),
		null == Jr && (Jr = {}),
		b(Jr, oa) ||
			P(Jr, oa, function () {
				return this;
	...
	!(function (e, t, n, i, r, a, o) {
		...
		if (
			(m && ((s = aa(m.call(new e()))), da !== Object.prototype && s.next && (aa(s) !== da && (Zn ? Zn(s, da) : 'function' != typeof s[fa] && P(s, fa, va)), Ht(s, h, !0))),
			'values' == r &&
				g &&
				'values' !== g.name &&
				((f = !0),
			...
			if (((l = { values: d('values'), keys: a ? p : d('keys'), entries: d('entries') }), o)) for (u in l) (ha || f || !(u in v)) && te(v, u, l[u]);
			...
			if (!o || !s || ('replace' === e && (!ba || !wa || Ea)) || ('split' === e && !ka)) {
				var l = /./[a],
					c = n(
						...
						''[e],
						function (e, t, n, i, r) {
							return t.exec === Gr ? (o && !r ? { done: !0, value: l.call(t, n, i) } : { done: !0, value: e.call(n, t, i) }) : { done: !1 };
						},
						{ REPLACE_KEEPS_$0: wa, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Ea }
					),
					u = c[0],
					d = c[1];
					...
					''.split(/.?/).length
						? function (e, n) {
								...
								for (
									...
									(s = Gr.call(g, a)) &&
									!((l = g.lastIndex) > f && (u.push(a.slice(f, s.index)), s.length > 1 && s.index < a.length && Pa.apply(u, s.slice(1)), (c = s[0].length), (f = l), u.length >= o));
	...
	var eo = function (e, t) {
					...
					},
					{
						...
						value: function (e) {
							...
							(e.style.display = this.Reveal.getConfig().display),
								to(e, 'img[data-src], video[data-src], audio[data-src], iframe[data-src]').forEach(function (e) {
								...
								if (!1 === i.hasAttribute('data-loaded')) {
									...
									if (o) r.style.backgroundImage = 'url(' + encodeURI(o) + ')';
										...
										l && u.setAttribute('loop', ''),
											c && (u.muted = !0),
											vo && ((u.muted = !0), (u.autoplay = !0), u.setAttribute('playsinline', '')),
						...
						value: function (e) {
							...
							if (t && t.contentWindow) {
								...
								if (n && i) {
									...
									'boolean' != typeof r && (r = t.hasAttribute('data-autoplay') || !!oo(t, '.slide-background')),
					...
					},
					{
						...
						value: function () {
							...
							if ('function' == typeof n.slideNumber) e = n.slideNumber(t);
								...
								switch (('string' == typeof n.slideNumber && (i = n.slideNumber), /c/.test(i) || 1 !== this.Reveal.getHorizontalSlides().length || (i = 'c'), (e = []), i)) {
									case 'c':
				...
				Fa(e, [
					...
					},
					{
						...
						value: function (e, t) {
							...
							return (
								(i.className = 'slide-background-content'), n.appendChild(i), t.appendChild(n), (e.slideBackgroundElement = n), (e.slideBackgroundContentElement = i), this.sync(e), n
							);
						}
					},
					{
									...
									e.classList.remove('past', 'present', 'future'),
										...
										(t || n === i.h) &&
											to(e, '.slide-background').forEach(function (e, t) {
												e.classList.remove('past', 'present', 'future'),
													t < i.v ? e.classList.add('past') : t > i.v ? e.classList.add('future') : (e.classList.add('present'), n === i.h && (r = e));
											});
								}),
						...
						value: function () {
							...
							if (this.Reveal.getConfig().parallaxBackgroundImage) {
								...
								var o,
									...
									l = i.length;
								o =
									('number' == typeof this.Reveal.getConfig().parallaxBackgroundHorizontal ? this.Reveal.getConfig().parallaxBackgroundHorizontal : l > 1 ? (t - s) / (l - 1) : 0) *
									e.h *
									-1;
								var c,
									u,
		...
		Ao = ct('filter');
	Me(
		{ target: 'Array', proto: !0, forced: !ko || !Ao },
		{
			filter: function (e) {
				return Eo(this, e, arguments.length > 1 ? arguments[1] : void 0);
			}
		}
	);
	var Ro = [].join,
		...
		Lo = at('join', ',');
	Me(
		{ target: 'Array', proto: !0, forced: xo || !Lo },
		{
			join: function (e) {
				return Ro.call(g(this), void 0 === e ? ',' : e);
			}
		}
	);
	var Co = function (e) {
		...
		Po = { left: Co(!1), right: Co(!0) }.left,
		No = at('reduce'),
		Mo = ct('reduce', { 1: 0 });
	Me(
		{ target: 'Array', proto: !0, forced: !No || !Mo },
		{
			reduce: function (e) {
	...
	var Io = Ye('slice'),
		Oo = ct('slice', { ACCESSORS: !0, 0: 0, 1: 2 }),
		To = Fe('species'),
		Do = [].slice,
		jo = Math.max;
	Me(
		{ target: 'Array', proto: !0, forced: !Io || !Oo },
		{
			slice: function (e, t) {
				var n,
					i,
					...
					s = he(e, o),
					l = he(void 0 === t ? o : t, o);
				if (Ie(a) && ('function' != typeof (n = a.constructor) || (n !== Array && !Ie(n.prototype)) ? p(n) && null === (n = n[To]) && (n = void 0) : (n = void 0), n === Array || void 0 === n))
					return Do.call(a, s, l);
				for (i = new (void 0 === n ? Array : n)(jo(l - s, 0)), r = 0; s < l; s++, r++) s in a && Te(i, r, a[s]);
				return (i.length = r), i;
			}
		}
	);
	...
	var Uo = 0,
						...
						value: function (e, t) {
							...
							if ((this.reset(), e.hasAttribute('data-auto-animate') && t.hasAttribute('data-auto-animate'))) {
								...
								var a = this.getAutoAnimatableElements(e, t).map(function (e) {
									return n.autoAnimateElements(e.from, e.to, e.options || {}, i, Uo++);
								});
								if ('false' !== t.dataset.autoAnimateUnmatched && !0 === this.Reveal.getConfig().autoAnimateUnmatched) {
									...
									this.getUnmatchedAutoAnimateElements(t).forEach(function (e) {
										...
										(t.duration === i.duration && t.delay === i.delay) ||
											((r = 'unmatched-' + Uo++),
											a.push(
												'[data-auto-animate="running"] [data-auto-animate-target="'.concat(r, '"] { transition: opacity ').concat(t.duration, 's ease ').concat(t.delay, 's; }')
											)),
						...
						value: function (e, t, n, i, r) {
							...
							t.classList.contains('fragment') &&
								...
								e.classList.contains('fragment') &&
									(e.className.match($a) || [''])[0] === (t.className.match($a) || [''])[0] &&
						...
						value: function () {
							...
							if (this.Reveal.getConfig().overview && !this.isActive()) {
								(this.active = !0),
									...
									to(this.Reveal.getRevealElement(), '.slides section').forEach(function (t) {
						...
						value: function () {
							...
							this.Reveal.getHorizontalSlides().forEach(function (t, n) {
								t.setAttribute('data-index-h', n),
									ro(t, 'translate3d(' + n * e.overviewSlideWidth + 'px, 0, 0)'),
							...
							if (!(r || a || o || u)) {
								...
								!1 === p &&
									...
									80 === n || 33 === n
										...
										? this.Reveal.slide(Number.MAX_VALUE)
										: 32 === n
										? (this.Reveal.overview.isActive() && this.Reveal.overview.deactivate(), e.shiftKey ? this.Reveal.prev() : this.Reveal.next())
									...
									p
										...
										: (27 !== n && 79 !== n) || (!1 === this.Reveal.closeOverlay() && this.Reveal.overview.toggle(), e.preventDefault && e.preventDefault()),
									this.Reveal.cueAutoSlide();
							}
						}
					}
						...
						value: function (e) {
							...
							if ((clearTimeout(this.writeURLTimeout), 'number' == typeof e)) this.writeURLTimeout = setTimeout(this.writeURL, e);
								...
								t.history
									...
									: t.hash &&
									  ('/' === i ? window.history.replaceState(null, null, window.location.pathname + window.location.search) : window.history.replaceState(null, null, '#' + i));
							}
						}
					},
					{
		...
		Xo = function (e) {
			return function (t) {
				for (var n, i = g(t), r = mt(i), o = r.length, s = 0, l = []; o > s; ) (n = r[s++]), (a && !$o.call(i, n)) || l.push(e ? [n, i[n]] : i[n]);
				return l;
			};
		},
		Yo = { entries: Xo(!0), values: Xo(!1) }.values;
	Me(
	...
	var Go = function (e, t) {
				...
				Fa(e, [
					{
						...
						value: function () {
							...
							lo('@page{size:' + n + 'px ' + i + 'px; margin: 0px;}'),
								lo('.reveal section>img, .reveal section>video, .reveal section>iframe{max-width: ' + r + 'px; max-height:' + a + 'px}'),
								...
								to(this.Reveal.getRevealElement(), '.slides section').forEach(function (t) {
									if (!1 === t.classList.contains('stack')) {
										...
										if (
											...
											(d.style.height = (i + e.pdfPageHeightOffset) * u + 'px'),
											...
											if (h) {
												...
												v.classList.add('speaker-notes'),
													...
													'separate-page' === f
														...
														: ((v.style.left = '8px'), (v.style.bottom = '8px'), (v.style.width = n - 16 + 'px'), d.appendChild(v));
											}
										}
										if (o) {
			...
			return (
				Fa(e, [
					...
					},
					{
						key: 'focus',
						value: function () {
							'focus' !== this.state && (this.Reveal.getRevealElement().classList.add('focused'), document.addEventListener('pointerdown', this.onDocumentPointerDown, !1)),
								(this.state = 'focus');
						}
					},
					{
						key: 'blur',
						value: function () {
							'blur' !== this.state && (this.Reveal.getRevealElement().classList.remove('focused'), document.removeEventListener('pointerdown', this.onDocumentPointerDown, !1)),
								(this.state = 'blur');
						}
					},
					{
		...
		ns = Fe('unscopables'),
		is = Array.prototype;
	null == is[ns] && C.f(is, ns, { configurable: !0, value: Ct(null) });
	Me(
		{ target: 'Array', proto: !0 },
		{
			fill: function (e) {
				for (var t = Oe(this), n = ce(t.length), i = arguments.length, r = he(i > 1 ? arguments[1] : void 0, n), a = i > 2 ? arguments[2] : void 0, o = void 0 === a ? n : he(a, n); o > r; )
					t[r++] = e;
				return t;
			}
		}
					...
					},
					{
						...
						value: function () {
							...
							this.context.save(),
								...
								this.playing
									? ((this.context.fillStyle = '#fff'), this.context.fillRect(0, 0, 10, 28), this.context.fillRect(18, 0, 10, 28))
									: (this.context.beginPath(),
	...
	function os(e, t) {
		...
		function H() {
			!0 === l.embedded ? (v.viewport = oo(e, '.reveal-viewport') || e) : ((v.viewport = document.body), document.documentElement.classList.add('reveal-full-page')),
		...
		function U() {
			(c = !0),
				...
				k.update(!0),
				setTimeout(function () {
					v.slides.classList.remove('no-transition'), v.wrapper.classList.add('ready'), Q({ type: 'ready', data: { indexh: n, indexv: i, currentSlide: a } });
				}, 1),
				I.isPrintingPDF() &&
					(X(),
		...
		function B() {
			l.showHiddenSlides ||
				to(v.wrapper, 'section[data-visibility="hidden"]').forEach(function (e) {
					e.parentNode.removeChild(e);
				});
		}
		function F() {
			v.slides.classList.add('no-transition'),
				vo ? v.wrapper.classList.add('no-hover') : v.wrapper.classList.remove('no-hover'),
				k.render(),
				S.render(),
				C.render(),
				P.render(),
				D.render(),
				(v.pauseOverlay = so(v.wrapper, 'div', 'pause-overlay', l.controls ? '<button class="resume-button">Resume presentation</button>' : null)),
				(v.statusElement = z()),
		...
		function K(e) {
			...
			if (('object' === Ha(e) && eo(l, e), !1 !== s.isReady())) {
				...
				v.wrapper.classList.remove(t.transition),
					...
					!1 === l.pause && pe(),
					l.previewLinks ? (ee(), te('[data-preview-link=false]')) : (te(), ee('[data-preview-link]:not([data-preview-link=false])')),
					E.reset(),
					o && (o.destroy(), (o = null)),
					n > 1 &&
						l.autoSlide &&
						l.autoSlideStoppable &&
						((o = new rs(v.wrapper, function () {
		...
		function J(e) {
			'string' == typeof e.layout && (f.layout = e.layout),
				...
				f.layout ? ro(v.slides, f.layout + ' ' + f.overview) : ro(v.slides, f.overview);
		}
		function Q(e) {
			var t = e.target,
			...
			s.initEvent(i, o, !0), eo(s, r), n.dispatchEvent(s), n === v.wrapper && Z(i);
		}
		function Z(e, t) {
		...
		function oe() {
			if (v.wrapper && !I.isPrintingPDF()) {
				if (!l.disableLayout) {
					vo && !l.embedded && document.documentElement.style.setProperty('--vh', 0.01 * window.innerHeight + 'px');
					var e = le(),
						t = h;
					se(l.width, l.height),
						...
						1 === (h = Math.min(h, l.maxScale))
							? ((v.slides.style.zoom = ''), (v.slides.style.left = ''), (v.slides.style.top = ''), (v.slides.style.bottom = ''), (v.slides.style.right = ''), J({ layout: '' }))
							: h > 1 && mo && window.devicePixelRatio < 2
							? ((v.slides.style.zoom = h), (v.slides.style.left = ''), (v.slides.style.top = ''), (v.slides.style.bottom = ''), (v.slides.style.right = ''), J({ layout: '' }))
							: ((v.slides.style.zoom = ''),
		...
		function ge() {
			if (l.pause) {
				...
				We(), v.wrapper.classList.add('paused'), !1 === e && Q({ type: 'paused' });
			}
		}
		function pe() {
			var e = v.wrapper.classList.contains('paused');
			v.wrapper.classList.remove('paused'), Ve(), e && Q({ type: 'resumed' });
		}
		function me(e) {
		...
		function Se(e, t, o, s) {
			...
			if (0 !== c.length) {
				...
				var h = n || 0,
					f = i || 0;
				(n = xe('.slides>section', void 0 === e ? n : e)), (i = xe('.slides>section.present>section', void 0 === t ? i : t));
				var p = n !== h || i !== f;
				p || (r = null);
				var m = c[n],
				...
				p &&
					...
					a &&
					!R.isActive() &&
					(r.hasAttribute('data-auto-animate') && a.hasAttribute('data-auto-animate') && ((b = !0), v.slides.classList.add('disable-slide-transitions')), (g = 'running')),
					Le(),
					oe(),
					R.isActive() && R.update(),
					void 0 !== o && A.goto(o),
		...
		function xe(e, t) {
			...
			if (i) {
				...
				c.classList.add('present'), c.removeAttribute('hidden'), c.removeAttribute('aria-hidden'), u || Q({ target: c, type: 'visible', bubbles: !1 });
		...
		function ze(e, t) {
			var n = 'number' == typeof e ? Fe(e, t) : e;
		...
		function _e(e) {
			if ('object' === Ha(e)) {
				Se(io(e.indexh), io(e.indexv), io(e.indexf));
				var t = io(e.paused),
					n = io(e.overview);
				...
				t
					...
					!p ||
						...
						((m = setTimeout(function () {
							'function' == typeof l.autoSlideMethod ? l.autoSlideMethod() : Ze(), Ve();
						}, p)),
						(y = Date.now())),
					o && o.setPlaying(-1 !== m);
			}
		...
		function $e() {
			p && b && ((b = !1), Q({ type: 'autoslideresumed' }), Ve());
		}
		function Xe() {
		...
		function Je() {
			(u.hasNavigatedVertically = !0), (R.isActive() || !1 === A.next()) && Ce().down && Se(n, i + 1);
		}
		function Qe() {
			var e;
			if (!1 === A.prev())
		...
		function tt(e) {
			'running' === g && /section/gi.test(e.target.nodeName) && ((g = 'idle'), Q({ type: 'slidetransitionend', data: { indexh: n, indexv: i, previousSlide: r, currentSlide: a } }));
		}
		function nt(e) {
			oe();
		}
	...
	return (
		(ss.initialize = function (e) {
			return (
				Object.assign(ss, new os(document.querySelector('.reveal'), e)),
				ls.map(function (e) {
					return e(ss);
				}),
				ss.initialize()
